...
public class OpenAssetLogHandler_AssetManager
{
    ...
    static bool OnOpenAsset(int instanceID, int line)
    {
        ...
        if (!string.IsNullOrEmpty(stackTrace) && stackTrace.Contains("[AssetManager]"))
        {
            ...
            while (matches.Success)
            {
                ...
                if (!pathLine.Contains("AssetBundleManager.cs:93"))
                {
