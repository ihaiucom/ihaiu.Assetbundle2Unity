...
//                                Object[] objs = ab.LoadAll();
								...
								objList.AddRange(ab.LoadAll(typeof(GameObject)));
								objList.AddRange(ab.LoadAll(typeof(Mesh)));
								objList.AddRange(ab.LoadAll(typeof(Material)));
								objList.AddRange(ab.LoadAll(typeof(Texture)));
								objList.AddRange(ab.LoadAll(typeof(AnimationClip)));
